...
class Config(object):
    ...
    def ConfigCommands(self):
        ...
        if self.lpgbt == "DAQ":
            ...
            self.linksWrite("delay.invert", 0, numLinks, self.link_capture)
            self.linksWrite("delay.words_little_endian", 0, numLinks, self.link_capture)
            self.linksWrite("delay.bytes_little_endian", 0, numLinks, self.link_capture)
            self.hw.dispatch()
